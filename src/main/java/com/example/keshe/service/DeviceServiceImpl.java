...
public class DeviceServiceImpl implements DeviceService {
    ...
    public Device updateDevice(Long id, Device deviceDetails) {
        ...
        existingDevice.setPort(deviceDetails.getPort());
        existingDevice.setProtocolType(deviceDetails.getProtocolType());
        existingDevice.setExternalDeviceId(deviceDetails.getExternalDeviceId());
        existingDevice.setModel(deviceDetails.getModel());
        existingDevice.setBrightness(deviceDetails.getBrightness());
        existingDevice.setColorTemp(deviceDetails.getColorTemp());
        existingDevice.setRgbColor(deviceDetails.getRgbColor());
